...
public class C01_Xpath {
    public static void main(String[] args) {
        ...
        WebElement addElementButonu = driver.findElement(By.xpath("/html/body/div[2]/div/div/button"));
        addElementButonu.click();
        //3- Delete butonu’nun gorunur oldugunu test edin
        WebElement deleteButonu =driver.findElement(By.xpath("/html/body/div[2]/div/div/div/button"));
